<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="招标分类" prop="zhaobiaofenlei">
          <el-select :disabled="ro.zhaobiaofenlei" v-model="ruleForm.zhaobiaofenlei" placeholder="请选择招标分类">
            <el-option
                v-for="(item,index) in zhaobiaofenleiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.zhaobiaowenjian" label="招标文件" prop="zhaobiaowenjian">
          <file-upload
          tip="点击上传招标文件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhaobiaowenjian" label="招标文件" prop="zhaobiaowenjian">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.zhaobiaowenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="单位电话" prop="danweidianhua">
          <el-input v-model="ruleForm.danweidianhua" 
              placeholder="单位电话" clearable  :readonly="ro.danweidianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="单位电话" prop="danweidianhua">
              <el-input v-model="ruleForm.danweidianhua" 
                placeholder="单位电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="法人代表" prop="farendaibiao">
          <el-input v-model="ruleForm.farendaibiao" 
              placeholder="法人代表" clearable  :readonly="ro.farendaibiao"></el-input>
        </el-form-item>
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="招标详情" prop="zhaobiaoxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zhaobiaoxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhaobiaoxiangqing" label="招标详情" prop="zhaobiaoxiangqing">
                    <span v-html="ruleForm.zhaobiaoxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiezhishijian = true;
          ...
          if(o=='zhaobiaoxiangqing'){
            this.ruleForm.zhaobiaoxiangqing = obj[o];
	    this.ro.zhaobiaoxiangqing = true;
            continue;
          }
          if(o=='fabushijian'){
	    ...
	    this.ro.zhaobiaodanwei = true;
          ...
          if(o=='danweidianhua'){
            this.ruleForm.danweidianhua = obj[o];
	    this.ro.danweidianhua = true;
            continue;
          }
          if(o=='farendaibiao'){
      ...
      this.$http({
		...
		if(json.danweimingcheng!=''&&json.danweimingcheng){
                this.ruleForm.zhaobiaodanwei = json.danweimingcheng
	    		this.ro.zhaobiaodanwei = true;
		}
		if(json.danweidianhua!=''&&json.danweidianhua){
                this.ruleForm.danweidianhua = json.danweidianhua
	    		this.ro.danweidianhua = true;
		}
		if(json.farendaibiao!=''&&json.farendaibiao){
                this.ruleForm.farendaibiao = json.farendaibiao
	    		this.ro.farendaibiao = true;
		}
        } else {
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/zhaobiaofenlei/zhaobiaofenlei`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.zhaobiaofenleiOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.zhaobiaoxiangqing = this.ruleForm.zhaobiaoxiangqing.replace(reg,'../../../app/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
