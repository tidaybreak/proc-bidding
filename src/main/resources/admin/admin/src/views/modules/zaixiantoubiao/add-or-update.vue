<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="投标时间" prop="toubiaoshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.toubiaoshijian" 
                type="datetime"
                :readonly="ro.toubiaoshijian"
                placeholder="投标时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.toubiaoshijian" label="投标时间" prop="toubiaoshijian">
              <el-input v-model="ruleForm.toubiaoshijian" 
                placeholder="投标时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.toubiaoshijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.toubiaoneirong = true;
          ...
          if(o=='toubiaoshijian'){
            this.ruleForm.toubiaoshijian = obj[o];
	    this.ro.toubiaoshijian = true;
            continue;
          }
	...
	this.ruleForm.toubiaoneirong = this.ruleForm.toubiaoneirong.replace(reg,'../../../app/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zaixiantoubiao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zaixiantoubiaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
