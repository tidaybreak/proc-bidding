...
var adminurl =  "http://b2b.ofidc.com/app/admin/dist/index.html";
...
var menu = [{
    ...
    "backMenu": [{
        "child": [{
            "appFrontIcon": "cuIcon-circle",
            "buttons": ["新增", "查看", "修改", "删除", "查看评论", "公示", "公告"],
            "menu": "招标项目",
            "menuJump": "列表",
            "tableName": "zhaobiaoxiangmu"
        }],
